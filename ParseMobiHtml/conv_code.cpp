...
namespace 
{
    ...
    const cp1252_to_utf8 cp1252_to_utf8_map[] =
    {
        ...
        //(*0xd3 * ) Some 0x00d3, Some "\xC3\x93", "LATIN CAPITAL LETTER O WITH ACUTE";
        {
            2, { 0xC3, 0x93 }
        },
        ...
        //(*0xdc * ) Some 0x00dc, Some "\xC3\x9C", "LATIN CAPITAL LETTER U WITH DIAERESIS";
        {
            2, { 0xC3, 0x9C }
        },
...
bool cp1252_to_utf8(char* buf, int len, std::string& text)
{
    bool result = false;
    int cur = 0;
    int pos = 0;
